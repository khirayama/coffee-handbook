...
import { selectShop, unselectShop, updateView } from 'presentations/pages/Shops/actionCreators';
import { IRawShop, IShop } from 'presentations/pages/Shops/interfaces';
